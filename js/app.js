(() => {
 ...
 const sceneInfo = [
 {
  ...
  values: {
  stickyMsg11OpacityIn: [0, 1, { start: 0.1, end: 0.2 }],
  stickyMsg11OpacityOut: [1, 0, { start: 0.25, end: 0.3 }],
 ...
 switch (currentScene) {
  ...
  let stickyMsg11Opacity = calcValue( sceneValues.stickyMsg11OpacityIn, currentYOffset );
  
  sceneObjs.stickyMsg11.style.opacity = stickyMsg11Opacity;
  console.log( stickyMsg11Opacity );
